"""
Automated Pytest for glasgow-blatchford-bleeding-score Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    GlasgowblatchfordbleedingscoreEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = GlasgowblatchfordbleedingscoreEnrichmentSuite()

"""
Live WebSocket Distributed Component Telemetry Streamer for glasgow-blatchford-bleeding-score.
"""
import json
import asyncio
...
class TelemetryBroadcaster:
    ...
    async def broadcast_event(self, event_type: str, data: Dict[str, Any]):
        msg = json.dumps({"system": "glasgow-blatchford-bleeding-score", "event_type": event_type, "payload": data})
